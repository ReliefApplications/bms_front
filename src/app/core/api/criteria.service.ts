...
export class CriteriaService{
    ...
    public getBeneficiariesNumber(distributionType: string, criteriaArray:any, project: string){
        let body = { "distribution_type" : distributionType, "criteria" : criteriaArray }

...
export class Arabic implements Language {
    ...
    //Log audit
        ...
        log_deactivate = 'منجز'
        log_delete = 'منجز'
        log_distributed = 'منجز'
        log_edit = 'منجز'
        log_import = 'منجز'
        log_remove = 'منجز'
        log_scanned = 'منجز'
        log_transaction = 'منجز'
        log_upload = 'منجز'      
        log_validate = 'منجز'

        //Fields
        log_field_action = 'منجز'
        log_field_country = 'منجز'
        log_field_date = 'منجز'
        log_field_details = 'منجز'
        log_field_id = 'منجز'
        log_field_object = 'منجز'
        log_field_status = 'منجز' // Exists 97
        log_field_user = 'منجز'

        //Objects
        log_beneficiary = 'منجز'   //Exists 41
        log_beneficiaries = 'منجز'   
        log_batch_vouchers = 'منجز'
        log_booklets = 'منجز'
        log_country_specifics = 'منجز'   //Exists 301
        log_distributions = 'منجز'     // Exists 47
        log_donor = 'منجز'
        log_donors = 'منجز'
        log_general_relief_item = 'منجز'
        log_households = 'منجز'    // Exists 52
        log_image = 'منجز' 
        log_email = 'منجز'
        log_language = 'منجز'
        log_logo = 'منجز'
        log_notes = 'منجز'
        log_organization = 'منجز'
        log_password = 'منجز'
        log_products = 'منجز'
        log_project = 'منجز'
        log_projects = 'منجز'
        ...
        logs = 'منجز'
        log_codes = 'منجز'
        log_family_name = 'منجز'
        log_field = 'منجز'
        log_old_id = 'منجز'
        log_name = 'منجز'
        log_not_exists = 'منجز'
        log_no_details = 'منجز'
        log_number_booklets = 'منجز'
        log_number_vouchers = 'منجز'
        log_requests_country = 'منجز'
        log_username = 'منجز'
        log_value = 'منجز'
        log_from = 'منجز'

...
export class Arabic implements Language {
    ...
    livelihood_service = 'صناعة الخدمات وغيرهم من المهنيين'
        ...
        log_remove = 'اختبار'
        log_scanned = 'اختبار'
        log_transaction = 'اختبار'
        log_upload = 'اختبار'
        log_validate = 'اختبار'

        //Fields
        logs = 'اختبار'
        log_field_action = 'اختبار'
        log_field_country = 'اختبار'
        log_field_date = 'اختبار'
        log_field_details = 'اختبار'
        log_field_id = 'اختبار'
        log_field_object = 'اختبار'
        log_field_status = 'اختبار'
        log_field_user = 'اختبار'

        //Objects
        log = 'اختبار'
        log_beneficiaries = 'اختبار'
        log_batch_vouchers = 'اختبار'
        log_booklets = 'اختبار'
        log_country_specifics = 'اختبار'
        log_deactivate = 'اختبار'
        log_distributions = 'اختبار'
        log_general_relief_item = 'اختبار'
        log_households = 'اختبار'
        log_image = 'اختبار' 
        log_email = 'اختبار'
        log_language = 'اختبار'
        log_logo = 'اختبار'
        log_notes = 'اختبار'
        log_organization = 'اختبار'
        log_password = 'اختبار'
        log_products = 'اختبار'
        log_provider = 'اختبار'
        log_region = 'اختبار'
        ...
        log_beneficiary_in_distributions = 'اختبار'
        log_beneficiaries_in_distributions = 'اختبار'
        /******************** */
        
        //Status
        log_status = 'اختبار'
        log_status_200 = 'اختبار'
        log_status_300 = 'اختبار'
        log_status_400 = 'اختبار'
        log_status_401 = 'اختبار'
        log_status_403 = 'اختبار'
        log_status_404 = 'اختبار'

        //Reports
        log_no_details = 'اختبار'
        log_requests_country = 'اختبار'

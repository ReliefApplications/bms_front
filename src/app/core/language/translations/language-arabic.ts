...
export class Arabic implements Language {
    ...
    //Log audit
        ...
        // log_delete = 'تم الحذف'
        // log_distributed = 'وزعت'
        // log_edit = 'تحرير'
        // log_import = 'مستورد'
        // log_remove = 'إزالة'
        // log_scanned = 'الممسوحة ضوئيا'
        // log_transaction = 'أرسلت'
        // log_upload = 'تم تحميلها'      
        ...
        log_field_status = 'وضع' // Exists 97
        log_field_user = 'المستخدم'

        //Objects
        // log_beneficiary = 'المستفيد'   //Exists 41
        // log_beneficiaries = 'المستفيدين'   
        // log_batch_vouchers = 'دفعة من القسائم'
        // log_booklets = 'كتيب'
        // log_country_specifics = 'خيار بلد معين'   //Exists 301
        // log_distributions = 'توزيع'     // Exists 47
        // log_donor = 'الجهات المانحة'
        // log_donors = 'الجهات المانحة'
        // log_general_relief_item = 'بند الإغاثة العامة'
        // log_households = 'منزلي'    // Exists 52
        // log_image = 'صورة' 
        // log_email = 'رمز المعاملة'
        // log_language = 'اللغة الافتراضية'
        // log_logo = 'شعار'
        // log_notes = 'ملاحظات'
        // log_organization = 'منظمة'
        // log_password = 'كلمه السر'
        // log_products = 'المنتج'
        // log_project = 'مشروع'
        // log_projects = 'مشروع'
        // log_provider = 'اتصال طرف ثالث'
        // log_region = 'منطقة محددة'
        // log_send = 'المال المحمول'
        // log_vendors = 'بائع'
        // log_vouchers = 'إيصال'

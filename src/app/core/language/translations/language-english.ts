...
export class English implements Language {
    ...
    //Log audit
    log_country_specifics = 'a country specific option'
    log_households = 'a household'
    log_distributions = 'a distribution'
    log_donors = 'a donor'
    log_donor = 'a donor'
    log_projects = 'a project'
    log_project = 'a project'
    log_users = 'a user'
    log_booklets = 'a booklet'
    log_products = 'a product'
    log_vendors = 'a vendor'
    log_vouchers = 'a voucher'
    log_beneficiary_in_distributions = 'a beneficiary in a distribution'
    log_beneficiaries_in_distributions = ''
    log_delete_batch_vouchers = 'a batch of vouchers'
    log_scanned = 'scanned'
    log_transaction = 'sent'
    log_send = 'mobile money'
    log_email = 'a transaction code'
    log_assign = 'assigned'
    log_complete = 'completed'
    log_validate = 'validated'
    log_beneficiaries = 'a beneficiary'
    log_add = 'added'
    log_notes = 'notes in'
    log_distributed = 'distributed'
    log_general_relief_item = 'a general relief item'
    ...
    log_import = 'imported'
    log_provider = 'a third party connection'

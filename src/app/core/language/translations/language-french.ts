...
export class French implements Language {
    ...
    //Log audit
        ...
        log_field_id = ''
        log_field_object = ''
        log_field_status = '' // Exists 97
        log_field_user = ''

        //Objects
        log_beneficiary = ''   //Exists 41
        log_beneficiaries = ''   
        log_batch_vouchers = ''
        log_booklets = ''
        log_country_specifics = ''   //Exists 301
        log_distributions = ''     // Exists 47
        log_donor = ''
        log_donors = ''
        log_general_relief_item = ''
        log_households = ''    // Exists 52
        log_image = '' 
        log_email = ''
        log_language = ''
        log_logo = ''

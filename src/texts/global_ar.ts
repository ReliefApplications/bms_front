export const TEXT = {
    ...
    tooltip_distributions: 'This page is the distribution\'s page. You can see all beneficiaries of the distribution. If you have the right, you can add new beneficiaries with a file or by selecting in the list, manage beneficiaries and validate the distribution to a transaction',
    ...
    tooltip_projects: 'This page is the projects\' page. You can see all projects of the country (only thoses that you have the right to see). If you have the right, you can add a new distribution with beneficiaries whose are in the project, manage distributions and transactions',

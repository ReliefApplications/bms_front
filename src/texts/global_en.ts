export const TEXT = {
    ...
    data_verification_snackbar_less_corrected: 'Beneficiaries successfully removed',
    data_verification_snackbar_more_corrected: 'Beneficiaries successfully added',
